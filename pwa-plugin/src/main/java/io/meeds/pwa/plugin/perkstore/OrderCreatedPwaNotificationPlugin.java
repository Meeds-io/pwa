...
@Profile("perk-store")
@Component
public class OrderCreatedPwaNotificationPlugin implements PwaNotificationPlugin {
  private static final String   TITLE_LABEL_KEY = "pwa.notification.OrderAddedNotificationPlugin.title";
  ...
  @Override
  public String getId() {
    return "OrderAddedNotificationPlugin";
  }
