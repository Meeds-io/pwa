...
import io.meeds.social.user.plugin.UserProfilePermanentLinkPlugin;

import lombok.Getter;

@Component
public class RelationshipRequestReceivedPwaNotificationPlugin implements PwaNotificationPlugin {

  private static final String   TITLE_LABEL_KEY = "pwa.notification.RelationshipReceivedRequestPlugin.title";
  ...
  @Override
  public String getId() {
    return "RelationshipReceivedRequestPlugin";
  }
  ...
  public PwaNotificationMessage process(NotificationInfo notification, LocaleConfig localeConfig) {
    ...
    String username = notification.getValueOwnerParameter(SocialNotificationUtils.SENDER.getKey());
