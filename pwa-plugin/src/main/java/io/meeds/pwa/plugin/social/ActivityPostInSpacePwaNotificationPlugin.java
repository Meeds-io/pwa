...
@Component
public class ActivityPostInSpacePwaNotificationPlugin extends BaseActivityPwaNotificationPlugin {

  private static final String   TITLE_LABEL_KEY = "pwa.notification.PostActivitySpaceStreamPlugin.title";

  @Override
  public String getId() {
    return "PostActivitySpaceStreamPlugin";
  }
  ...
  public PwaNotificationMessage process(NotificationInfo notification, LocaleConfig localeConfig) {
    ...
    notificationMessage.setBody(getActivityContent(notification));
    notificationMessage.setTitle(resourceBundleService.getSharedString(TITLE_LABEL_KEY,
