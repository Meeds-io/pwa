...
@Component
public class ActivityCommentPwaNotificationPlugin extends BaseActivityPwaNotificationPlugin {

  private static final String   TITLE_LABEL_KEY = "pwa.notification.ActivityCommentPlugin.title";

  @Override
  public String getId() {
    return "ActivityCommentPlugin";
  }
