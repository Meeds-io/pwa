...
@Profile("wallet")
@Component
public class EtherReceiverPwaNotificationPlugin implements PwaNotificationPlugin {

  private static final String   TITLE_LABEL_KEY = "pwa.notification.EtherReceiverNotificationPlugin.title";
  ...
  @Override
  public String getId() {
    return "EtherReceiverNotificationPlugin";
  }
  ...
  public PwaNotificationMessage process(NotificationInfo notification, LocaleConfig localeConfig) {
    ...
    PermanentLinkObject object = new PermanentLinkObject("wallet", notification.getValueOwnerParameter("receiverIdentityId"));
