...
@Profile("task")
@Component
public class TaskCommentedPwaNotificationPlugin implements PwaNotificationPlugin {
  private static final String   TITLE_LABEL_KEY = "pwa.notification.TaskCommentedPlugin.title";
