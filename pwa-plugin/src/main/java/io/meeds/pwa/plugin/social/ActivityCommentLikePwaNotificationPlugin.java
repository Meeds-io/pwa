...
@Component
public class ActivityCommentLikePwaNotificationPlugin extends BaseActivityPwaNotificationPlugin {

  private static final String   TITLE_LABEL_KEY = "pwa.notification.LikeCommentPlugin.title";

  @Override
  public String getId() {
    return "LikeCommentPlugin";
  }
