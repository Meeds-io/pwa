...
@Component
public class ActivityCommentReplyPwaNotificationPlugin extends BaseActivityPwaNotificationPlugin {

  private static final String   TITLE_LABEL_KEY = "pwa.notification.ActivityReplyToCommentPlugin.title";

  @Override
  public String getId() {
    return "ActivityReplyToCommentPlugin";
  }
