...
@Profile("perk-store")
@Component
public class OrderModifiedPwaNotificationPlugin implements PwaNotificationPlugin {
  private static final String   TITLE_LABEL_KEY = "pwa.notification.OrderModifiedNotificationPlugin.title";
  ...
  @Override
  public String getId() {
    return "OrderModifiedNotificationPlugin";
  }
  ...
  public PwaNotificationMessage process(NotificationInfo notification, LocaleConfig localeConfig) {
    ...
    PermanentLinkObject object = new PermanentLinkObject("perkstore",
                                                         notification.getValueOwnerParameter("PRODUCT_ID"),
                                                         Collections.singletonMap("orderId",
                                                                                  notification.getValueOwnerParameter("ORDER_ID")));
