...
@Component
public class GamificationContributionRejectedPwaNotificationPlugin implements PwaNotificationPlugin {
  private static final String   TITLE_LABEL_KEY = "pwa.notification.GamificationContributionRejectedNotification.title";
  ...
  @Override
  public String getId() {
    return "GamificationContributionRejectedNotification";
  }
