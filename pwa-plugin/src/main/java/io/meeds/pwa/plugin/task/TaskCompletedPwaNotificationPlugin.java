...
@Profile("task")
@Component
public class TaskCompletedPwaNotificationPlugin implements PwaNotificationPlugin {
  private static final String   TITLE_LABEL_KEY = "pwa.notification.TaskCompletedPlugin.title";
