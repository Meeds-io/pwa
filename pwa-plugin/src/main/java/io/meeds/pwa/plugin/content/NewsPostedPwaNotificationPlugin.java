...
@Profile("content")
@Component
public class NewsPostedPwaNotificationPlugin implements PwaNotificationPlugin {

  private static final String   TITLE_LABEL_KEY = "pwa.notification.PostNewsNotificationPlugin.title";
  ...
  @Override
  public String getId() {
    return "PostNewsNotificationPlugin";
  }
