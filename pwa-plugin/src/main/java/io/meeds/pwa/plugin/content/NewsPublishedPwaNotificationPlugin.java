...
@Profile("content")
@Component
public class NewsPublishedPwaNotificationPlugin implements PwaNotificationPlugin {

  private static final String   TITLE_LABEL_KEY = "pwa.notification.PublishNewsNotificationPlugin.title";
  ...
  @Override
  public String getId() {
    return "PublishNewsNotificationPlugin";
  }
  ...
  public PwaNotificationMessage process(NotificationInfo notification, LocaleConfig localeConfig) {
    ...
    notificationMessage.setUrl(permanentLinkService.getPermanentLink(new PermanentLinkObject("news",
                                                                                             notification.getValueOwnerParameter("NEWS_ID"))));
