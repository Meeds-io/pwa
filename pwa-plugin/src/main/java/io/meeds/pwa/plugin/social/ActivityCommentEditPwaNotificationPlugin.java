...
@Component
public class ActivityCommentEditPwaNotificationPlugin extends BaseActivityPwaNotificationPlugin {

  private static final String   TITLE_LABEL_KEY = "pwa.notification.EditCommentPlugin.title";

  @Override
  public String getId() {
    return "EditCommentPlugin";
  }
