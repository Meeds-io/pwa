...
@Component
public class ActivitySharePwaNotificationPlugin extends BaseActivityPwaNotificationPlugin {

  private static final String TITLE_LABEL_KEY = "pwa.notification.SharedActivitySpaceStreamPlugin.title";

  @Override
  public String getId() {
    return "SharedActivitySpaceStreamPlugin";
  }
