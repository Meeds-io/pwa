...
@Component
public class ActivityCommentWatchPwaNotificationPlugin extends BaseActivityPwaNotificationPlugin {

  private static final String   TITLE_LABEL_KEY = "pwa.notification.ActivityCommentWatchPlugin.title";

  @Override
  public String getId() {
    return "ActivityCommentWatchPlugin";
  }
