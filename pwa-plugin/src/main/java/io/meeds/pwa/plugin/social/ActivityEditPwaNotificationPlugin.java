...
@Component
public class ActivityEditPwaNotificationPlugin extends BaseActivityPwaNotificationPlugin {

  private static final String   TITLE_LABEL_KEY = "pwa.notification.EditActivityPlugin.title";

  @Override
  public String getId() {
    return "EditActivityPlugin";
  }
